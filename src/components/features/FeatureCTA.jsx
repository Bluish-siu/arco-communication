...
export default function FeatureCTA() {
  return (
    <section className="py-20 sm:py-28 lg:py-32 bg-slate-950 text-white relative overflow-hidden" id="features-cta">
      ...
      <Container className="relative z-10">
        <div className="max-w-3xl mx-auto text-center flex flex-col items-center">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-white leading-[1.15]">
            Everything your team needs to grow through conversations
          </h2>

          {/* Description */}
          <p className="mt-5 sm:mt-6 text-base sm:text-lg text-slate-300 leading-relaxed max-w-2xl">
            Bring marketing, sales, support, and automation together with ARCO Communication.
          </p>
